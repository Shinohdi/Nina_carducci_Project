...
!(function (t, e) {
    ...
    class mt extends B {
        ...
        show() {
            ...
            if (this._config.parent) {
                const t = V.find(ft, this._config.parent);
                e = V.find(".collapse.show, .collapse.collapsing", this._config.parent).filter((e) => !t.includes(e));
            }
            const i = V.findOne(this._selector);
            if (e.length) {
                const n = e.find((t) => i !== t);
                if (((t = n ? mt.getInstance(n) : null), t && t._isTransitioning)) return;
            }
            if (j.trigger(this._element, "show.bs.collapse").defaultPrevented) return;
            e.forEach((e) => {
                i !== e && mt.getOrCreateInstance(e, { toggle: !1 }).hide(), t || H.set(e, rt, null);
            });
            ...
            this._queueCallback(
                () => {
                    (this._isTransitioning = !1),
                        ...
                        this._element.classList.add(ht, ct),
        ...
        hide() {
            ...
            (this._element.style[t] = `${this._element.getBoundingClientRect()[t]}px`),
                u(this._element),
                this._element.classList.add(dt),
                this._element.classList.remove(ht, ct);
        ...
        _getConfig(t) {
            return ((t = { ...at, ...U.getDataAttributes(this._element), ...t }).toggle = Boolean(t.toggle)), (t.parent = r(t.parent)), a(ot, t, lt), t;
        }
        _getDimension() {
    ...
    j.on(document, "click.bs.collapse.data-api", pt, function (t) {
    ...
    function Xt(t) {
        var e = Kt(t),
            ...
            n = t.offsetHeight;
        return (
            Math.abs(e.width - i) <= 1 && (i = e.width), Math.abs(e.height - n) <= 1 && (n = e.height), { x: t.offsetLeft, y: t.offsetTop, width: i, height: n }
        );
    }
    function Yt(t, e) {
    ...
    function Jt(t) {
        return "html" === Wt(t) ? t : t.assignedSlot || t.parentNode || (Ft(t) ? t.host : null) || Zt(t);
    }
    function te(t) {
        return qt(t) && "fixed" !== Qt(t).position ? t.offsetParent : null;
    }
    function ee(t) {
        for (var e = $t(t), i = te(t); i && Gt(i) && "static" === Qt(i).position; ) i = te(i);
        return i && ("html" === Wt(i) || ("body" === Wt(i) && "static" === Qt(i).position))
            ? e
            : i ||
                  (function (t) {
                      var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
                      if (-1 !== navigator.userAgent.indexOf("Trident") && qt(t) && "fixed" === Qt(t).position) return null;
                      for (var i = Jt(t); qt(i) && ["html", "body"].indexOf(Wt(i)) < 0; ) {
                          var n = Qt(i);
                          if (
                              "none" !== n.transform ||
                              "none" !== n.perspective ||
    ...
    const ce = {
        ...
        fn: function (t) {
            ...
            if (o && r) {
                var h = (function (t, e) {
                        return ae(
                            "number" != typeof (t = "function" == typeof t ? t(Object.assign({}, e.rects, { placement: e.placement })) : t) ? t : le(t, wt)
                        );
                    })(s.padding, i),
                    d = Xt(o),
                    u = "y" === l ? gt : vt,
    ...
    function ue(t) {
        ...
        if (c) {
            var w = ee(i),
                E = "clientHeight",
                A = "clientWidth";
            w === $t(i) && "static" !== Qt((w = Zt(i))).position && "absolute" === a && ((E = "scrollHeight"), (A = "scrollWidth")),
                (w = w),
                (s !== gt && ((s !== vt && s !== bt) || o !== At)) || ((v = _t), (m -= w[E] - n.height), (m *= l ? 1 : -1)),
                (s !== vt && ((s !== gt && s !== _t) || o !== At)) || ((b = bt), (f -= w[A] - n.width), (f *= l ? 1 : -1));
        }
        var T,
    ...
    const fe = {
        ...
        fn: function (t) {
            var e = t.state,
                ...
                a = i.roundOffsets,
                l = void 0 === a || a,
                c = { placement: Vt(e.placement), variation: he(e.placement), popper: e.elements.popper, popperRect: e.rects.popper, gpuAcceleration: s };
    ...
    function we(t) {
        return Kt(Zt(t)).left + ye(t).scrollLeft;
    }
    function Ee(t) {
        var e = Qt(t),
            i = e.overflow,
    ...
    function Ae(t) {
        return ["html", "body", "#document"].indexOf(Wt(t)) >= 0 ? t.ownerDocument.body : qt(t) && Ee(t) ? t : Ae(Jt(t));
    }
    function Te(t, e) {
        var i;
        void 0 === e && (e = []);
            ...
            : Oe(
                  (function (t) {
                      var e,
                          ...
                          a = -n.scrollLeft + we(t),
                          l = -n.scrollTop;
                      return "rtl" === Qt(s || i).direction && (a += ne(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l };
                  })(Zt(t))
              );
    }
    function ke(t, e, i) {
        var n =
                "clippingParents" === e
                    ? (function (t) {
                          var e = Te(Jt(t)),
                              i = ["absolute", "fixed"].indexOf(Qt(t).position) >= 0 && qt(t) ? ee(t) : t;
                          return zt(i)
                              ? e.filter(function (t) {
                                    return zt(t) && Yt(t, i) && "body" !== Wt(t);
                                })
                              : [];
                      })(t)
                    : [].concat(e),
            ...
            r = s.reduce(function (e, i) {
                var n = Ce(t, i);
                return (e.top = ne(n.top, e.top)), (e.right = se(n.right, e.right)), (e.bottom = se(n.bottom, e.bottom)), (e.left = ne(n.left, e.left)), e;
            }, Ce(t, o));
    ...
    function xe(t, e) {
        ...
        var i = e,
            ...
            f = i.padding,
            p = void 0 === f ? 0 : f,
            m = ae("number" != typeof p ? p : le(p, wt)),
            g = h === Ct ? kt : Ct,
            _ = t.rects.popper,
            b = t.elements[u ? g : h],
            v = ke(zt(b) ? b : b.contextElement || Zt(t.elements.popper), r, l),
            y = Kt(t.elements.reference),
            w = Le({ reference: y, element: _, strategy: "absolute", placement: s }),
            E = Oe(Object.assign({}, _, w)),
            A = h === Ct ? E : y,
                ...
                for (
                    var s = i.mainAxis,
                        ...
                        v = [g].concat(b).reduce(function (t, i) {
                            return t.concat(
                                Vt(i) === yt
                                    ? De(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m })
                                    : i
                            );
                        }, []),
                        y = e.rects.reference,
                    ...
                    var C = v[O],
                        ...
                        x = [gt, _t].indexOf(k) >= 0,
                        D = x ? "width" : "height",
                        S = xe(e, { placement: C, boundary: h, rootBoundary: d, altBoundary: u, padding: c }),
                        N = x ? (L ? bt : vt) : L ? _t : gt;
                    y[D] > w[D] && (N = _e(N));
                    var I = _e(N),
                        P = [];
                    ...
                    return (
                        (t[i] = (function (t, e, i) {
                            var n = Vt(t),
                                ...
                                r = o[0],
                                a = o[1];
                            return (r = r || 0), (a = (a || 0) * s), [vt, bt].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a };
                        })(i, e.rects, o)),
                        t
                    );
                }, {}),
    ...
    const Me = {
        ...
        fn: function (t) {
            var e = t.state,
                i = t.name;
            e.modifiersData[i] = Le({ reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement });
        },
        data: {},
    };
    const He = {
        ...
        fn: function (t) {
            var e = t.state,
                ...
                p = i.tetherOffset,
                m = void 0 === p ? 0 : p,
                g = xe(e, { boundary: l, rootBoundary: c, padding: d, altBoundary: h }),
                _ = Vt(e.placement),
                b = he(e.placement),
                v = !b,
                y = ie(_),
            ...
            if (E) {
                if (o || a) {
                    var k = "y" === y ? gt : vt,
                        ...
                        X = E[y] + q - V;
                    if (o) {
                        var Y = re(f ? se(S, K) : S, D, f ? ne(N, X) : N);
                        (E[y] = Y), (C[y] = Y - D);
                    }
                    if (a) {
                        var Q = "x" === y ? gt : vt,
                            ...
                            J = Z + g[Q],
                            tt = Z - g[G],
                            et = re(f ? se(J, K) : J, Z, f ? ne(tt, X) : tt);
                        (E[w] = et), (C[w] = et - Z);
                    }
                }
                e.modifiersData[n] = C;
    ...
    function Be(t, e, i) {
        ...
        return (
            (n || (!n && !i)) &&
                (("body" !== Wt(e) || Ee(r)) && (l = (s = e) !== $t(s) && qt(s) ? { scrollLeft: (o = s).scrollLeft, scrollTop: o.scrollTop } : ye(s)),
                qt(e) ? (((c = Kt(e)).x += e.clientLeft), (c.y += e.clientTop)) : r && (c.x = we(r))),
                ...
                h = {
                    ...
                    setOptions: function (i) {
                        ...
                        d(),
                            ...
                            (a.scrollParents = { reference: zt(t) ? Te(t) : t.contextElement ? Te(t.contextElement) : [], popper: Te(e) });
                        var r,
                            c,
                            u = (function (t) {
                                var e = Re(t);
                    ...
                    forceUpdate: function () {
                        if (!c) {
                            var t = a.elements,
                                ...
                                i = t.popper;
                            if ($e(e, i)) {
                                (a.rects = { reference: Be(e, ee(i), "fixed" === a.options.strategy), popper: Xt(i) }),
                                    (a.reset = !1),
    ...
    var qe = ze(),
        Fe = ze({ defaultModifiers: [me, Me, fe, Ut] }),
        Ue = ze({ defaultModifiers: [me, Me, fe, Ut, je, Se, He, ce, Pe] });
    const Ve = Object.freeze({
        ...
        ai = m() ? "bottom-start" : "bottom-end",
        li = m() ? "left-start" : "right-start",
        ci = m() ? "right-start" : "left-start",
    ...
    class ui extends B {
        ...
        _getConfig(t) {
            if (
                ...
                a(Ke, t, this.constructor.DefaultType),
        ...
        _getMenuElement() {
            return V.next(this._element, ni)[0];
        }
        _getPlacement() {
        ...
        _selectMenuItem({ key: t, target: e }) {
            ...
            i.length && v(i, e, t === Ge, !i.includes(e)).focus();
        }
        static jQueryInterface(t) {
            return this.each(function () {
        ...
        static dataApiKeydownHandler(t) {
            if (
                /input|textarea/i.test(t.target.tagName)
                    ? t.key === Ye || (t.key !== Xe && ((t.key !== Ge && t.key !== Qe) || t.target.closest(ni)))
                    : !Ze.test(t.key)
            )
                return;
            ...
            const i = this.matches(ii) ? this : V.prev(this, ii)[0],
    ...
    j.on(document, ti, ii, ui.dataApiKeydownHandler),
        j.on(document, ti, ni, ui.dataApiKeydownHandler),
        j.on(document, Je, ui.clearMenus),
        j.on(document, "keyup.bs.dropdown.data-api", ui.clearMenus),
        j.on(document, Je, ii, function (t) {
    ...
    class mi {
        ...
        hide() {
            ...
            this._disableOverFlow(),
                ...
                this._setElementAttributes(pi, "marginRight", (e) => e - t);
        }
        _disableOverFlow() {
    ...
    class wi {
        ...
        _getConfig(t) {
            return ((t = { ...gi, ...("object" == typeof t ? t : {}) }).rootElement = r(t.rootElement)), a(bi, t, _i), t;
        }
        _append() {
            this._isAppended ||
                (this._config.rootElement.append(this._getElement()),
                j.on(this._getElement(), yi, () => {
                    _(this._config.clickCallback);
                }),
                (this._isAppended = !0));
        }
        dispose() {
            this._isAppended && (j.off(this._element, yi), this._element.remove(), (this._isAppended = !1));
        }
        _emulateAnimation(t) {
            b(t, this._getElement(), this._config.isAnimated);
        }
    }
    const Ei = { trapElement: null, autofocus: !0 },
        Ai = { trapElement: "element", autofocus: "boolean" },
        Ti = ".bs.focustrap",
        Oi = "backward";
    class Ci {
        constructor(t) {
        ...
        deactivate() {
            this._isActive && ((this._isActive = !1), j.off(document, Ti));
        }
        _handleFocusin(t) {
            const { target: e } = t,
            ...
            0 === n.length ? i.focus() : this._lastTabNavDirection === Oi ? n[n.length - 1].focus() : n[0].focus();
        }
        _handleKeydown(t) {
            "Tab" === t.key && (this._lastTabNavDirection = t.shiftKey ? Oi : "forward");
        }
        _getConfig(t) {
            return (t = { ...Ei, ...("object" == typeof t ? t : {}) }), a("focustrap", t, Ai), t;
        }
    }
    const ki = "modal",
        Li = ".bs.modal",
        xi = "Escape",
        Di = { backdrop: !0, keyboard: !0, focus: !0 },
        Si = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean" },
        Ni = "hidden.bs.modal",
        Ii = "show.bs.modal",
        Pi = "resize.bs.modal",
        ji = "click.dismiss.bs.modal",
        Mi = "keydown.dismiss.bs.modal",
    ...
    class $i extends B {
        ...
        show(t) {
            ...
            j.trigger(this._element, Ii, { relatedTarget: t }).defaultPrevented ||
                ((this._isShown = !0),
        ...
        hide() {
            ...
            t && (this._isTransitioning = !0),
                ...
                j.off(this._element, ji),
                j.off(this._dialog, Hi),
                this._queueCallback(() => this._hideModal(), this._element, t);
        }
        dispose() {
            [window, this._dialog].forEach((t) => j.off(t, Li)), this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose();
        }
        handleUpdate() {
            this._adjustDialog();
        }
        ...
        _getConfig(t) {
            return (t = { ...Di, ...U.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }), a(ki, t, Si), t;
        }
        _showElement(t) {
        ...
        _setEscapeEvent() {
            this._isShown
                ? j.on(this._element, Mi, (t) => {
                      this._config.keyboard && t.key === xi
                          ? (t.preventDefault(), this.hide())
                          : this._config.keyboard || t.key !== xi || this._triggerBackdropTransition();
                  })
                : j.off(this._element, Mi);
        }
        _setResizeEvent() {
            this._isShown ? j.on(window, Pi, () => this._adjustDialog()) : j.off(window, Pi);
        }
        _hideModal() {
            (this._element.style.display = "none"),
                ...
                (this._isTransitioning = !1),
                this._backdrop.hide(() => {
                    document.body.classList.remove(Bi), this._resetAdjustments(), this._scrollBar.reset(), j.trigger(this._element, Ni);
                });
        }
        _showBackdrop(t) {
            j.on(this._element, ji, (t) => {
    ...
    const zi = "offcanvas",
        ...
        Fi = { backdrop: "boolean", keyboard: "boolean", scroll: "boolean" },
        Ui = "show",
        Vi = ".offcanvas.show",
    ...
    class Xi extends B {
        ...
        show(t) {
            ...
            if (j.trigger(this._element, "show.bs.offcanvas", { relatedTarget: t }).defaultPrevented) return;
            (this._isShown = !0),
        ...
        hide() {
            if (!this._isShown) return;
            if (j.trigger(this._element, "hide.bs.offcanvas").defaultPrevented) return;
        ...
        _getConfig(t) {
            return (t = { ...qi, ...U.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }), a(zi, t, Fi), t;
        }
        _initializeBackDrop() {
            return new wi({
    ...
    j.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function (t) {
        ...
        const i = V.findOne(Vi);
        i && i !== e && Xi.getInstance(i).hide();
        Xi.getOrCreateInstance(e).toggle(this);
    }),
        j.on(window, "load.bs.offcanvas.data-api", () => V.find(Vi).forEach((t) => Xi.getOrCreateInstance(t).show())),
        R(Xi),
        g(Xi);
    const Yi = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
        ...
        Zi = (t, e) => {
            ...
            if (e.includes(i)) return !Yi.has(i) || Boolean(Qi.test(t.nodeValue) || Gi.test(t.nodeValue));
    ...
    function tn(t, e, i) {
        ...
        for (let t = 0, i = s.length; t < i; t++) {
            ...
            const o = [].concat(...i.attributes),
                r = [].concat(e["*"] || [], e[n] || []);
            o.forEach((t) => {
                Zi(t, r) || i.removeAttribute(t.nodeName);
            });
        }
    ...
    const en = "tooltip",
        ...
        on = { AUTO: "auto", TOP: "top", RIGHT: m() ? "left" : "right", BOTTOM: "bottom", LEFT: m() ? "right" : "left" },
        rn = {
            animation: !0,
    ...
    class _n extends B {
        ...
        dispose() {
            clearTimeout(this._timeout),
                j.off(this._element.closest(fn), pn, this._hideModalHandler),
        ...
        show() {
            ...
            "tooltip" === this.constructor.NAME &&
                this.tip &&
                this.getTitle() !== this.tip.querySelector(un).innerHTML &&
            ...
            n.setAttribute("id", s), this._element.setAttribute("aria-describedby", s), this._config.animation && n.classList.add(ln);
            ...
            H.set(n, this.constructor.DATA_KEY, this),
                ...
                this._popper ? this._popper.update() : (this._popper = Ue(this._element, n, this._getPopperConfig(r))),
                n.classList.add(cn);
            ...
            const c = this.tip.classList.contains(ln);
            this._queueCallback(
                () => {
                    const t = this._hoverState;
                    (this._hoverState = null), j.trigger(this._element, this.constructor.Event.SHOWN), t === dn && this._leave(null, this);
                },
                this.tip,
                c
            );
        ...
        hide() {
            ...
            const e = this.tip.classList.contains(ln);
            this._queueCallback(
                () => {
                    this._isWithActiveTrigger() ||
                        (this._hoverState !== hn && t.remove(),
                        this._cleanTipClass(),
        ...
        getTipElement() {
            ...
            return this.setContent(e), e.classList.remove(ln, cn), (this.tip = e), this.tip;
        }
        setContent(t) {
            this._sanitizeAndSetContent(t, this.getTitle(), un);
        }
            ...
            if (null !== t)
                return o(e)
                    ...
                    : void (this._config.html
                          ? (this._config.sanitize && (e = tn(e, this._config.allowList, this._config.sanitizeFn)), (t.innerHTML = e))
                          : (t.textContent = e));
        }
        getTitle() {
        ...
        _setListeners() {
            this._config.trigger.split(" ").forEach((t) => {
                if ("click" === t) j.on(this._element, this.constructor.Event.CLICK, this._config.selector, (t) => this.toggle(t));
                    ...
                    const e = t === mn ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN,
                        i = t === mn ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
                ...
                j.on(this._element.closest(fn), pn, this._hideModalHandler),
        ...
        _enter(t, e) {
            (e = this._initializeOnDelegatedTarget(t, e)),
                t && (e._activeTrigger["focusin" === t.type ? gn : mn] = !0),
                e.getTipElement().classList.contains(cn) || e._hoverState === hn
                    ? (e._hoverState = hn)
        ...
        _leave(t, e) {
            (e = this._initializeOnDelegatedTarget(t, e)),
                t && (e._activeTrigger["focusout" === t.type ? gn : mn] = e._element.contains(t.relatedTarget)),
                e._isWithActiveTrigger() ||
                    (clearTimeout(e._timeout),
                    (e._hoverState = dn),
                    e._config.delay && e._config.delay.hide
                        ? (e._timeout = setTimeout(() => {
                              e._hoverState === dn && e.hide();
        ...
        _getConfig(t) {
            ...
            return (
                ...
                a(en, t, this.constructor.DefaultType),
                t.sanitize && (t.template = tn(t.template, t.allowList, t.sanitizeFn)),
                t
            );
        }
        _getDelegateConfig() {
    ...
    const bn = {
        ...
        vn = { ..._n.DefaultType, content: "(string|element|function)" },
        yn = {
    ...
    class Sn extends B {
        ...
        refresh() {
            const t = this._scrollElement === this._scrollElement.window ? "offset" : Dn,
                e = "auto" === this._config.method ? t : this._config.method,
                n = e === Dn ? this._getScrollTop() : 0;
            (this._offsets = []), (this._targets = []), (this._scrollHeight = this._getScrollHeight());
            V.find(xn, this._config.target)
                .map((t) => {
                    const s = i(t),
        ...
        dispose() {
            j.off(this._scrollElement, An), super.dispose();
        }
        _getConfig(t) {
            return (
                ((t = { ...Tn, ...U.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }).target =
        ...
        _activate(t) {
            ...
            const e = xn.split(",").map((e) => `${e}[data-bs-target="${t}"],${e}[href="${t}"]`),
                i = V.findOne(e.join(","), this._config.target);
            i.classList.add(kn),
                i.classList.contains(Cn)
                    ? V.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add(kn)
                    : V.parents(i, ".nav, .list-group").forEach((t) => {
                          V.prev(t, ".nav-link, .list-group-item").forEach((t) => t.classList.add(kn)),
                              V.prev(t, ".nav-item").forEach((t) => {
                                  V.children(t, Ln).forEach((t) => t.classList.add(kn));
                              });
                      }),
        ...
        _clear() {
            V.find(xn, this._config.target)
                .filter((t) => t.classList.contains(kn))
                .forEach((t) => t.classList.remove(kn));
        }
        static jQueryInterface(t) {
            return this.each(function () {
    ...
    j.on(window, "load.bs.scrollspy.data-api", () => {
        V.find('[data-bs-spy="scroll"]').forEach((t) => new Sn(t));
    }),
        g(Sn);
    const Nn = "active",
        In = "fade",
    ...
    class Hn extends B {
        ...
        show() {
            ...
            if (i) {
                const e = "UL" === i.nodeName || "OL" === i.nodeName ? Mn : jn;
        ...
        _activate(t, e, i) {
            const n = (!e || ("UL" !== e.nodeName && "OL" !== e.nodeName) ? V.children(e, jn) : V.find(Mn, e))[0],
                s = i && n && n.classList.contains(In),
                o = () => this._transitionComplete(t, n, i);
            n && s ? (n.classList.remove(Pn), this._queueCallback(o, t, !0)) : o();
        }
        _transitionComplete(t, e, i) {
            ...
            t.classList.add(Nn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), u(t), t.classList.contains(In) && t.classList.add(Pn);
            let n = t.parentNode;
            if ((n && "LI" === n.nodeName && (n = n.parentNode), n && n.classList.contains("dropdown-menu"))) {
                const e = t.closest(".dropdown");
                e && V.find(".dropdown-toggle", e).forEach((t) => t.classList.add(Nn)), t.setAttribute("aria-expanded", !0);
            }
            i && i();
        }
        static jQueryInterface(t) {
            return this.each(function () {
                const e = Hn.getOrCreateInstance(this);
                if ("string" == typeof t) {
                    if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
                    e[t]();
                }
    ...
    j.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', function (t) {
        if ((["A", "AREA"].includes(this.tagName) && t.preventDefault(), c(this))) return;
        Hn.getOrCreateInstance(this).show();
    }),
        g(Hn);
    const Bn = "toast",
        Rn = "hide",
        ...
        qn = { animation: !0, autohide: !0, delay: 5e3 };
    class Fn extends B {
        constructor(t, e) {
            super(t),
                (this._config = this._getConfig(e)),
        ...
        show() {
            if (j.trigger(this._element, "show.bs.toast").defaultPrevented) return;
            ...
            this._element.classList.remove(Rn),
                ...
                this._queueCallback(
                    () => {
                        this._element.classList.remove($n), j.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide();
                    },
                    this._element,
        ...
        hide() {
            if (!this._element.classList.contains(Wn)) return;
            if (j.trigger(this._element, "hide.bs.toast").defaultPrevented) return;
            this._element.classList.add($n),
                this._queueCallback(
                    () => {
        ...
        dispose() {
            this._clearTimeout(), this._element.classList.contains(Wn) && this._element.classList.remove(Wn), super.dispose();
        }
        _getConfig(t) {
            return (t = { ...qn, ...U.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }), a(Bn, t, this.constructor.DefaultType), t;
        }
        _maybeScheduleHide() {
