...
(function (global, factory) {
    ...
    const EventHandler = {
        ...
        trigger(element, event, args) {
            ...
            if (isNative) {
                ...
                evt = new CustomEvent(event, { bubbles, cancelable: !0 });
            }
    ...
    const Default$a = { interval: 5000, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0 };
    const DefaultType$a = {
    ...
    const KEY_TO_DIRECTION = { [ARROW_LEFT_KEY]: DIRECTION_RIGHT, [ARROW_RIGHT_KEY]: DIRECTION_LEFT };
    ...
    class Carousel extends BaseComponent {
        ...
        _triggerSlideEvent(relatedTarget, eventDirectionName) {
            ...
            return EventHandler.trigger(this._element, EVENT_SLIDE, { relatedTarget, direction: eventDirectionName, from: fromIndex, to: targetIndex });
        }
        ...
        show() {
            ...
            actives.forEach((elemActive) => {
                if (container !== elemActive) {
                    Collapse.getOrCreateInstance(elemActive, { toggle: !1 }).hide();
                }
                if (!activesData) {
    ...
    EventHandler.on(document, EVENT_CLICK_DATA_API$4, SELECTOR_DATA_TOGGLE$4, function (event) {
        ...
        selectorElements.forEach((element) => {
            Collapse.getOrCreateInstance(element, { toggle: !1 }).toggle();
        });
    });
        ...
        Object.keys(state.elements).forEach(function (name) {
            ...
            Object.keys(attributes).forEach(function (name) {
                ...
                if (value === !1) {
                    ...
                    element.setAttribute(name, value === !0 ? "" : value);
                }
            });
        });
    }
    ...
    function mapToStyles(_ref2) {
        ...
        var _ref3 = roundOffsets === !0 ? roundOffsetsByDPR(offsets) : typeof roundOffsets === "function" ? roundOffsets(offsets) : offsets,
            _ref3$x = _ref3.x,
        ...
        var commonStyles = Object.assign({ position: position }, adaptive && unsetSides);
        if (gpuAcceleration) {
            var _Object$assign;
    ...
    function computeStyles(_ref4) {
        ...
        if (state.modifiersData.arrow != null) {
            state.styles.arrow = Object.assign(
                ...
                state.styles.arrow,
                mapToStyles(
                    Object.assign({}, commonStyles, { offsets: state.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: roundOffsets })
                )
            );
        }
    ...
    const eventListeners = { name: "eventListeners", enabled: !0, phase: "write", fn: function fn() {}, effect: effect, data: {} };
    ...
    function detectOverflow(state, options) {
        ...
        var popperOffsets = computeOffsets({ reference: referenceClientRect, element: popperRect, strategy: "absolute", placement: placement });
    ...
    function computeAutoPlacement(state, options) {
        ...
        var overflows = allowedPlacements.reduce(function (acc, placement) {
            acc[placement] = detectOverflow(state, { placement: placement, boundary: boundary, rootBoundary: rootBoundary, padding: padding })[
    ...
    function hide(_ref) {
        ...
        var popperAltOverflow = detectOverflow(state, { altBoundary: !0 });
    ...
    function distanceAndSkiddingToXY(placement, rects, offset) {
        ...
        var _ref = typeof offset === "function" ? offset(Object.assign({}, rects, { placement: placement })) : offset,
            skidding = _ref[0],
            distance = _ref[1];
        skidding = skidding || 0;
    ...
    function preventOverflow(_ref) {
        ...
        var overflow = detectOverflow(state, { boundary: boundary, rootBoundary: rootBoundary, padding: padding, altBoundary: altBoundary });
        var basePlacement = getBasePlacement(state.placement);
        ...
        var tetherOffsetValue =
            typeof tetherOffset === "function" ? tetherOffset(Object.assign({}, state.rects, { placement: state.placement })) : tetherOffset;
        var data = { x: 0, y: 0 };
        if (!popperOffsets) {
            return;
        }
    ...
    var createPopper$1 = popperGenerator({ defaultModifiers: defaultModifiers$1 });
    ...
    class Dropdown extends BaseComponent {
        ...
        _getPopperConfig() {
            ...
            if (this._config.display === "static") {
                defaultBsPopperConfig.modifiers = [{ name: "applyStyles", enabled: !1 }];
            }
            return {
        ...
        static dataApiKeydownHandler(event) {
            if (
                /input|textarea/i.test(event.target.tagName)
                    ? event.key === SPACE_KEY ||
                      (event.key !== ESCAPE_KEY$2 && ((event.key !== ARROW_DOWN_KEY && event.key !== ARROW_UP_KEY) || event.target.closest(SELECTOR_MENU)))
        ...
        _getPopperConfig(attachment) {
            const defaultBsPopperConfig = {
                ...
                modifiers: [
                    ...
                    { name: "onChange", enabled: !0, phase: "afterWrite", fn: (data) => this._handlePopperPlacementChange(data) },
                ],
                onFirstUpdate: (data) => {
    ...
    class Tab extends BaseComponent {
        ...
        show() {
            ...
            const hideEvent = previous ? EventHandler.trigger(previous, EVENT_HIDE$1, { relatedTarget: this._element }) : null;
            const showEvent = EventHandler.trigger(this._element, EVENT_SHOW$1, { relatedTarget: previous });
            if (showEvent.defaultPrevented || (hideEvent !== null && hideEvent.defaultPrevented)) {
                return;
            }
            this._activate(this._element, listElement);
            const complete = () => {
                EventHandler.trigger(previous, EVENT_HIDDEN$1, { relatedTarget: this._element });
                EventHandler.trigger(this._element, EVENT_SHOWN$1, { relatedTarget: previous });
            };
            if (target) {
    ...
    const Default = { animation: !0, autohide: !0, delay: 5000 };
    ...
    const index_umd = { Alert, Button, Carousel, Collapse, Dropdown, Modal, Offcanvas, Popover, ScrollSpy, Tab, Toast, Tooltip };
    return index_umd;
});
